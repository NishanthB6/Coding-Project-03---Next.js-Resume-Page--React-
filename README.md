...
- [x] **Tailwind CSS Styling:** 100% utility-first styling; no custom CSS rules in `globals.css`.
- [x] **Responsive Design:** Mobile-friendly layout using Tailwind's `sm:` and `flex` utilities.
